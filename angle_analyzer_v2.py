...
print "\nExamine the file with the desired steps and choose the atoms that will be a part of the angle:\n"


sets_of_3_rows = []
sets_of_3_rows = inputSetsOfThreeRows()
