...
# Example:
# python data_crusher_3000.py pe_prod.gro OP9 HH7
...
print "\nWelcome to Data Crusher 3000! (mix_prod.gro version!!!)"
...
def getLinesOfInterest(original_lines):
	...
	# that we want
	strings_of_interest = ["OR6", "HH7", "OP9", "HO10", "OW", "HW1", "HW2"]
...
def correctsNameOfAtom(atom_information):
	...
	if "OW" in atom_information[1] or "OW1" in atom_information[1]:

		atom_information[1] = "OW"

	if "HW1" in atom_information[1] or "HW11" in atom_information[1]:

		atom_information[1] = "HW1"

	if "HW2" in atom_information[1] or "HW21" in atom_information[1]:

		atom_information[1] = "HW2"
...
##### FUNCTION THAT MAKES ALL CALCULATION ##############
...
def makesAllCalculations(information_matrix, atom1, atom2):
	...
	name_of_output_file = "another_dist_" + atom1 + "_" + atom2 +"_dist.txt"
...
original_lines = getValuesFromFile(path)
...
#print lines_of_interest[len(lines_of_interest)-1]
...
#print cleaned_lines_of_interest[len(cleaned_lines_of_interest)-1]
...
#print relevant_info[len(relevant_info)-1]
...
#print information_matrix[len(information_matrix)-1]
